...
from src.services.ml_service.models.translators.marian import OpusTextTranslationModel
from src.services.ml_service.models.translators.qwen import QwenTextTranslationModel
